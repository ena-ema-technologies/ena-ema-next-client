...
const CreateServicePage = () => {
  ...
  const serviceSchema = z.object({
    ...
    relevantWorkSample1: z.string({
      required_error: 'relevant sample1 needed',
    }),
    relevantWorkSample2: z.string({
      required_error: 'relevant sample2 needed',
    }),
    relevantWorkSample3: z.string({
      required_error: 'relevant sample3 needed',
    }),
    ...
    <div className="col-span-3 px-4 lg:px-0">
      ...
      <EnaForm onSubmit={onSubmit} resolver={zodResolver(serviceSchema)}>
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-4 my-5 ">
          <EnaInput
            type="text"
            name="relevantWorkSample2"
            placeholder="your user id"
          />
          <EnaInput
            type="text"
            name="relevantWorkSample3"
            placeholder="your user id"
          />
          <EnaInput
            type="text"
